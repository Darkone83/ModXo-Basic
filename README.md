...
V4: Top of PCB revised, RGB port minimized to 3P, EXP removed and replaced with a standardized XSMB port ensuring compatibility with future accessories. Bottom of PCB revised accessory power circuit revised with IC1, C1, C2, and R1. Components on the bottom of the PCB are not required for normal operation; if not in place, voltage to the ports will not be supplied.
